...
public class PostService {
    ...
    static {
        posts.add(
                new Post(1, "Katniss Everdeen", new Date(), 2, "Ugh. I'm so hungry. Does anyone want to play a game?"));
        ...
        posts.add(
                new Post(8, "Kenny Powers", new Date(), -1, "Anyone want a kid? I'm done with this. F*** this noise."));
    }
